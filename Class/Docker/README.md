...
- #### Docker Image Build Process
  ...
  ![Build Java App](Images/dockerfile1.png)

- #### Java Application Running in Container

  ![Running](Images/dockerfile2.png)
  ![Running](Images/dockerfile3.png)

- #### Docker Image Published on Docker Hub

![Running](Images/dockerfile4.png)
![Running](Images/dockerfile5.png)
